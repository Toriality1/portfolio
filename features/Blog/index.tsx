      ...
      <div className="mx-auto w-fit">
        ...
        <div className="relative h-[80vh] overflow-hidden">
          <div className="absolute bottom-0 flex h-1/2 w-full justify-end bg-gradient-to-t from-black from-10% to-transparent">
            <button className="group m-auto mb-10 w-fit translate-y-10 border-2 border-neutral-600/50 p-1 transition hover:border-neutral-800/50 disabled:pointer-events-none disabled:opacity-70">
